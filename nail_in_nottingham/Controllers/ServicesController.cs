...
namespace nail_in_nottingham.Controllers
{
    public class ServicesController : Controller
    {
        ...
        public ActionResult Index()
        {
            ...
            //List<ServiceMaster> serviceList = db.ServiceMasters.ToList();
    ...
    //public ActionResult Create([Bind(Include = "service_id,service_type,service_desc")] Service service)
    //{
    ...
    //[HttpPost]
    //[ValidateAntiForgeryToken]
    //public ActionResult Edit([Bind(Include = "service_id,service_type,service_desc")] Service service)
    //{
    //    if (ModelState.IsValid)
    //    {
