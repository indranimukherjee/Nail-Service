...
{
    public class NailServiceInitializer : DropCreateDatabaseAlways<NailModel>
    {
        protected override void Seed(NailModel context)
        {
            ...
            serviceBillDeskList.Add(new ServiceBillDesk() { ServiceID = 1, ServiceDuration = "20mins", ServicePrice = "£20", ServiceVeriationID = 1, ServiceAmount = "£20", ServiceQuantity = 1 });
            serviceBillDeskList.Add(new ServiceBillDesk() { ServiceID = 1, ServiceDuration = "30mins", ServicePrice = "£30", ServiceVeriationID = 2, ServiceAmount = "£30", ServiceQuantity = 1 });
            serviceBillDeskList.Add(new ServiceBillDesk() { ServiceID = 1, ServiceDuration = "15mins", ServicePrice = "£45", ServiceVeriationID = 3, ServiceAmount = "£45", ServiceQuantity = 1 });
            serviceBillDeskList.Add(new ServiceBillDesk() { ServiceID = 2, ServiceDuration = "20mins", ServicePrice = "£20", ServiceVeriationID = 1, ServiceAmount = "£20", ServiceQuantity = 1 });
            serviceBillDeskList.Add(new ServiceBillDesk() { ServiceID = 2, ServiceDuration = "30mins", ServicePrice = "£30", ServiceVeriationID = 2, ServiceAmount = "£40", ServiceQuantity = 1 });
            serviceBillDeskList.Add(new ServiceBillDesk() { ServiceID = 2, ServiceDuration = "15mins", ServicePrice = "£45", ServiceVeriationID = 3, ServiceAmount = "£45", ServiceQuantity = 1 });
            serviceBillDeskList.Add(new ServiceBillDesk() { ServiceID = 3, ServiceDuration = "20mins", ServicePrice = "£20", ServiceVeriationID = 1, ServiceAmount = "£20", ServiceQuantity = 1 });
            serviceBillDeskList.Add(new ServiceBillDesk() { ServiceID = 3, ServiceDuration = "30mins", ServicePrice = "£30", ServiceVeriationID = 2, ServiceAmount = "£30", ServiceQuantity = 1 });
            serviceBillDeskList.Add(new ServiceBillDesk() { ServiceID = 3, ServiceDuration = "15mins", ServicePrice = "£45", ServiceVeriationID = 3, ServiceAmount = "£45", ServiceQuantity = 1 });
            serviceBillDeskList.Add(new ServiceBillDesk() { ServiceID = 4, ServiceDuration = "20mins", ServicePrice = "£20", ServiceVeriationID = 1, ServiceAmount = "£20", ServiceQuantity = 1 });
            serviceBillDeskList.Add(new ServiceBillDesk() { ServiceID = 4, ServiceDuration = "30mins", ServicePrice = "£30", ServiceVeriationID = 2, ServiceAmount = "£30", ServiceQuantity = 1 });
            serviceBillDeskList.Add(new ServiceBillDesk() { ServiceID = 4, ServiceDuration = "15mins", ServicePrice = "£45", ServiceVeriationID = 3, ServiceAmount = "£60", ServiceQuantity = 1 });
            serviceBillDeskList.Add(new ServiceBillDesk() { ServiceID = 5, ServiceDuration = "20mins", ServicePrice = "£20", ServiceVeriationID = 1, ServiceAmount = "£20", ServiceQuantity = 1 });
            serviceBillDeskList.Add(new ServiceBillDesk() { ServiceID = 5, ServiceDuration = "30mins", ServicePrice = "£30", ServiceVeriationID = 2, ServiceAmount = "£30", ServiceQuantity = 1 });
            serviceBillDeskList.Add(new ServiceBillDesk() { ServiceID = 5, ServiceDuration = "15mins", ServicePrice = "£45", ServiceVeriationID = 3, ServiceAmount = "£45", ServiceQuantity = 1 });
            serviceBillDeskList.Add(new ServiceBillDesk() { ServiceID = 6, ServiceDuration = "20mins", ServicePrice = "£20", ServiceVeriationID = 1, ServiceAmount = "£20", ServiceQuantity = 1 });
            serviceBillDeskList.Add(new ServiceBillDesk() { ServiceID = 6, ServiceDuration = "30mins", ServicePrice = "£30", ServiceVeriationID = 2, ServiceAmount = "£30", ServiceQuantity = 1 });
            serviceBillDeskList.Add(new ServiceBillDesk() { ServiceID = 6, ServiceDuration = "15mins", ServicePrice = "£45", ServiceVeriationID = 3, ServiceAmount = "£45", ServiceQuantity = 1 });
            serviceBillDeskList.Add(new ServiceBillDesk() { ServiceID = 7, ServiceDuration = "30mins", ServicePrice = "£50", ServiceVeriationID = 1, ServiceAmount = "£50", ServiceQuantity = 1 });
            serviceBillDeskList.Add(new ServiceBillDesk() { ServiceID = 7, ServiceDuration = "40mins", ServicePrice = "£60", ServiceVeriationID = 2, ServiceAmount = "£60", ServiceQuantity = 1 });
            serviceBillDeskList.Add(new ServiceBillDesk() { ServiceID = 7, ServiceDuration = "20mins", ServicePrice = "£70", ServiceVeriationID = 3, ServiceAmount = "£70", ServiceQuantity = 1 });
            serviceBillDeskList.Add(new ServiceBillDesk() { ServiceID = 8, ServiceDuration = "20mins", ServicePrice = "£20", ServiceVeriationID = 1, ServiceAmount = "£20", ServiceQuantity = 1 });
            serviceBillDeskList.Add(new ServiceBillDesk() { ServiceID = 8, ServiceDuration = "30mins", ServicePrice = "£30", ServiceVeriationID = 2, ServiceAmount = "£30", ServiceQuantity = 1 });
            serviceBillDeskList.Add(new ServiceBillDesk() { ServiceID = 8, ServiceDuration = "15mins", ServicePrice = "£45", ServiceVeriationID = 3, ServiceAmount = "£45", ServiceQuantity = 1 });
            serviceBillDeskList.Add(new ServiceBillDesk() { ServiceID = 9, ServiceDuration = "20mins", ServicePrice = "£20", ServiceVeriationID = 1, ServiceAmount = "£20", ServiceQuantity = 1 });
            serviceBillDeskList.Add(new ServiceBillDesk() { ServiceID = 9, ServiceDuration = "30mins", ServicePrice = "£30", ServiceVeriationID = 2, ServiceAmount = "£30", ServiceQuantity = 1 });
            serviceBillDeskList.Add(new ServiceBillDesk() { ServiceID = 9, ServiceDuration = "15mins", ServicePrice = "£45", ServiceVeriationID = 3, ServiceAmount = "£45", ServiceQuantity = 1 });
            serviceBillDeskList.Add(new ServiceBillDesk() { ServiceID = 10, ServiceDuration = "20mins", ServicePrice = "£30", ServiceVeriationID = 1, ServiceAmount = "£30", ServiceQuantity = 1 });
            serviceBillDeskList.Add(new ServiceBillDesk() { ServiceID = 10, ServiceDuration = "30mins", ServicePrice = "£40", ServiceVeriationID = 2, ServiceAmount = "£40", ServiceQuantity = 1 });
            serviceBillDeskList.Add(new ServiceBillDesk() { ServiceID = 10, ServiceDuration = "15mins", ServicePrice = "£50", ServiceVeriationID = 3, ServiceAmount = "£50", ServiceQuantity = 1 });
            serviceBillDeskList.Add(new ServiceBillDesk() { ServiceID = 11, ServiceDuration = "20mins", ServicePrice = "£30", ServiceVeriationID = 1, ServiceAmount = "£30", ServiceQuantity = 1 });
            serviceBillDeskList.Add(new ServiceBillDesk() { ServiceID = 11, ServiceDuration = "30mins", ServicePrice = "£40", ServiceVeriationID = 2, ServiceAmount = "£40", ServiceQuantity = 1 });
